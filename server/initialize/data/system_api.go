...
var systemUserAuthAndPermissionApis = []model.SystemApi{
	...
	{Name: "用户批量添加", Path: "/system/user/multi-add", Method: "POST", Description: "用户批量添加接口", NeedPermission: trans.Uint(1), CategoryId: 3},
	{Name: "用户编辑", Path: "/system/user/update", Method: "POST", Description: "用户编辑接口", NeedPermission: trans.Uint(1), CategoryId: 3},
	{Name: "用户状态修改", Path: "/system/user/modify-status", Method: "POST", Description: "用户状态修改接口", NeedPermission: trans.Uint(1), CategoryId: 3},
	{Name: "用户批量状态修改", Path: "/system/user/multi-modify-status", Method: "POST", Description: "用户批量状态修改接口", NeedPermission: trans.Uint(1), CategoryId: 3},
}
